  ...
  const plantsArray = [
    ...
    },
    {
      ...
      plants: [
        ...
        { name: "Geraniums", image: "https://cdn.pixabay.com/photo/2012/04/26/21/51/flowerpot-43270_1280.jpg", description: "Known for insect-repelling properties while adding a pleasant scent.", cost: "$20" },
  ...
  return (
    <div>
      <div className="navbar">
        ...
        <a href="#" onClick={handlePlantsClick} style={{ color: 'white', fontSize: '28px' }}>
          Plants
        </a>
